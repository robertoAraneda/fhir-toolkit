...
export class Flag extends DomainResource implements IFlag {
  ...
  subject: IReference<'Patient' | 'Location' | 'Group' | 'Organization' | 'Practitioner' | 'PlanDefinition' | 'Medication' | 'Procedure'>;
  ...
  /** Flag creator */
  author?: IReference<'Device' | 'Organization' | 'Patient' | 'Practitioner' | 'PractitionerRole'>;
