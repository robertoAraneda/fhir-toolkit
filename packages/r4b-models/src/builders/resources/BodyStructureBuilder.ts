...
export class BodyStructureBuilder extends DomainResourceBuilder<BodyStructure, IBodyStructure> {
   ...
   * Body site
   */
  setLocation(location: ICodeableConcept): this {
  ...
  /**
   * Add locationQualifier
   * Body site modifier
   */
  addLocationQualifier(locationQualifier: ICodeableConcept): this {
    return this.addToArray('locationQualifier', locationQualifier);
  }
