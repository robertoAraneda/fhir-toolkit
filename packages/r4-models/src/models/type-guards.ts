...
/**
 * Check if a resource is a EffectEvidenceSynthesis
 * @param resource - The resource to check
 * @returns True if the resource is a EffectEvidenceSynthesis
 */
export function isEffectEvidenceSynthesis(resource: any): resource is IEffectEvidenceSynthesis {
  return resource?.resourceType === 'EffectEvidenceSynthesis';
}
...
/**
 * Check if a resource is a MedicinalProduct
 * @param resource - The resource to check
 * @returns True if the resource is a MedicinalProduct
 */
export function isMedicinalProduct(resource: any): resource is IMedicinalProduct {
  return resource?.resourceType === 'MedicinalProduct';
}

/**
 * Check if a resource is a MedicinalProductAuthorization
 * @param resource - The resource to check
 * @returns True if the resource is a MedicinalProductAuthorization
 */
export function isMedicinalProductAuthorization(resource: any): resource is IMedicinalProductAuthorization {
  return resource?.resourceType === 'MedicinalProductAuthorization';
}

/**
 * Check if a resource is a MedicinalProductContraindication
 * @param resource - The resource to check
 * @returns True if the resource is a MedicinalProductContraindication
 */
export function isMedicinalProductContraindication(resource: any): resource is IMedicinalProductContraindication {
  return resource?.resourceType === 'MedicinalProductContraindication';
}

/**
 * Check if a resource is a MedicinalProductIndication
 * @param resource - The resource to check
 * @returns True if the resource is a MedicinalProductIndication
 */
export function isMedicinalProductIndication(resource: any): resource is IMedicinalProductIndication {
  return resource?.resourceType === 'MedicinalProductIndication';
}

/**
 * Check if a resource is a MedicinalProductIngredient
 * @param resource - The resource to check
 * @returns True if the resource is a MedicinalProductIngredient
 */
export function isMedicinalProductIngredient(resource: any): resource is IMedicinalProductIngredient {
  return resource?.resourceType === 'MedicinalProductIngredient';
}

/**
 * Check if a resource is a MedicinalProductInteraction
 * @param resource - The resource to check
 * @returns True if the resource is a MedicinalProductInteraction
 */
export function isMedicinalProductInteraction(resource: any): resource is IMedicinalProductInteraction {
  return resource?.resourceType === 'MedicinalProductInteraction';
}

/**
 * Check if a resource is a MedicinalProductManufactured
 * @param resource - The resource to check
 * @returns True if the resource is a MedicinalProductManufactured
 */
export function isMedicinalProductManufactured(resource: any): resource is IMedicinalProductManufactured {
  return resource?.resourceType === 'MedicinalProductManufactured';
}

/**
 * Check if a resource is a MedicinalProductPackaged
 * @param resource - The resource to check
 * @returns True if the resource is a MedicinalProductPackaged
 */
export function isMedicinalProductPackaged(resource: any): resource is IMedicinalProductPackaged {
  return resource?.resourceType === 'MedicinalProductPackaged';
}

/**
 * Check if a resource is a MedicinalProductPharmaceutical
 * @param resource - The resource to check
 * @returns True if the resource is a MedicinalProductPharmaceutical
 */
export function isMedicinalProductPharmaceutical(resource: any): resource is IMedicinalProductPharmaceutical {
  return resource?.resourceType === 'MedicinalProductPharmaceutical';
}

/**
 * Check if a resource is a MedicinalProductUndesirableEffect
 * @param resource - The resource to check
 * @returns True if the resource is a MedicinalProductUndesirableEffect
 */
export function isMedicinalProductUndesirableEffect(resource: any): resource is IMedicinalProductUndesirableEffect {
  return resource?.resourceType === 'MedicinalProductUndesirableEffect';
}
...
/**
 * Check if a resource is a RiskEvidenceSynthesis
 * @param resource - The resource to check
 * @returns True if the resource is a RiskEvidenceSynthesis
 */
export function isRiskEvidenceSynthesis(resource: any): resource is IRiskEvidenceSynthesis {
  return resource?.resourceType === 'RiskEvidenceSynthesis';
}
...
/**
 * Check if a resource is a SubstanceSpecification
 * @param resource - The resource to check
 * @returns True if the resource is a SubstanceSpecification
 */
export function isSubstanceSpecification(resource: any): resource is ISubstanceSpecification {
  return resource?.resourceType === 'SubstanceSpecification';
}
