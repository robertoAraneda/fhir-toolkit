...
export class FlagBuilder extends DomainResourceBuilder<Flag, IFlag> {
   ...
   */
  setSubject(subject: IReference<'Patient' | 'Location' | 'Group' | 'Organization' | 'Practitioner' | 'PlanDefinition' | 'Medication' | 'Procedure'>): this {
   ...
   * Flag creator
   */
  setAuthor(author: IReference<'Device' | 'Organization' | 'Patient' | 'Practitioner' | 'PractitionerRole'>): this {
