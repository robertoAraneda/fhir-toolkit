...
import { RiskEvidenceSynthesis } from '../../models/resources/RiskEvidenceSynthesis.js';
import type {
  IAnnotation,
  ICodeableConcept,
  IContactDetail,
...
/**
 * RiskEvidenceSynthesisBuilder - Fluent builder for RiskEvidenceSynthesis resources
 *
 ...
 *
 * @example
 * const riskEvidenceSynthesis = new RiskEvidenceSynthesisBuilder()
 *   .setId('123')
 *   .setUrl(value)
 *   .addIdentifier({ ... })
 *   .build();
 */
export class RiskEvidenceSynthesisBuilder extends DomainResourceBuilder<RiskEvidenceSynthesis, IRiskEvidenceSynthesis> {
  // ============================================================================
  // Scalar Properties
  // ============================================================================
   ...
   */
  setSampleSize(sampleSize: IRiskEvidenceSynthesisSampleSize): this {
   ...
   */
  setRiskEstimate(riskEstimate: IRiskEvidenceSynthesisRiskEstimate): this {
    this.data.riskEstimate = riskEstimate;
    return this;
  }
   ...
   */
  addCertainty(certainty: IRiskEvidenceSynthesisCertainty): this {
  ...
  /**
   * Build the RiskEvidenceSynthesis instance
   */
  build(): RiskEvidenceSynthesis {
    return new RiskEvidenceSynthesis(this.data);
  }

  /**
   * Build and validate the RiskEvidenceSynthesis instance
   * @throws Error if validation fails
   */
  async buildOrThrow(): Promise<RiskEvidenceSynthesis> {
    const riskEvidenceSynthesis = this.build();
    await riskEvidenceSynthesis.validateOrThrow();
