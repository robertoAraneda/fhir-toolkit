...
export class GoalBuilder extends DomainResourceBuilder<Goal, IGoal> {
  ...
  setContinuous(continuous: boolean): this {
    this.data.continuous = continuous;
    return this;
  }
   ...
   */
  setSource(source: IReference<'Patient' | 'Practitioner' | 'PractitionerRole' | 'RelatedPerson' | 'CareTeam'>): this {
   ...
   */
  addAddresses(addresse: IReference<'Condition' | 'Observation' | 'MedicationStatement' | 'MedicationRequest' | 'NutritionOrder' | 'ServiceRequest' | 'RiskAssessment' | 'Procedure'>): this {
   ...
   */
  addOutcome(outcome: ICodeableReference): this {
