...
export class ImplementationGuideBuilder extends DomainResourceBuilder<ImplementationGuide, IImplementationGuide> {
  ...
  setVersionAlgorithm<T extends 'String' | 'Coding'>(
    ...
    const key = `versionAlgorithm${type}` as keyof IImplementationGuide;
    const otherKeys: (keyof IImplementationGuide)[] = [];
    if (type !== 'String') {
      otherKeys.push('versionAlgorithmString' as keyof IImplementationGuide);
      otherKeys.push('_versionAlgorithmString' as keyof IImplementationGuide);
    }
    if (type !== 'Coding') {
      otherKeys.push('versionAlgorithmCoding' as keyof IImplementationGuide);
      otherKeys.push('_versionAlgorithmCoding' as keyof IImplementationGuide);
    }
