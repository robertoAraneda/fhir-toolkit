...
export class RegulatedAuthorizationBuilder extends DomainResourceBuilder<RegulatedAuthorization, IRegulatedAuthorization> {
   ...
   */
  addSubject(subject: IReference<'MedicinalProductDefinition' | 'BiologicallyDerivedProduct' | 'NutritionProduct' | 'PackagedProductDefinition' | 'ManufacturedItemDefinition' | 'Ingredient' | 'SubstanceDefinition' | 'DeviceDefinition' | 'ResearchStudy' | 'ActivityDefinition' | 'PlanDefinition' | 'ObservationDefinition' | 'Practitioner' | 'Organization' | 'Location'>): this {
