...
export class ClinicalUseDefinitionBuilder extends DomainResourceBuilder<ClinicalUseDefinition, IClinicalUseDefinition> {
   ...
   */
  addSubject(subject: IReference<'MedicinalProductDefinition' | 'Medication' | 'ActivityDefinition' | 'PlanDefinition' | 'Device' | 'DeviceDefinition' | 'Substance' | 'NutritionProduct' | 'BiologicallyDerivedProduct'>): this {
