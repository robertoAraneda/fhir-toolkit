...
export class CommunicationRequestBuilder extends DomainResourceBuilder<CommunicationRequest, ICommunicationRequest> {
   ...
   */
  addRecipient(recipient: IReference<'Device' | 'Organization' | 'Patient' | 'Practitioner' | 'PractitionerRole' | 'RelatedPerson' | 'Group' | 'CareTeam' | 'HealthcareService' | 'Endpoint'>): this {
    return this.addToArray('recipient', recipient);
  }

  /**
   * Add informationProvider
   * Who should share the information
   */
  addInformationProvider(informationProvider: IReference<'Device' | 'Organization' | 'Patient' | 'Practitioner' | 'PractitionerRole' | 'RelatedPerson' | 'HealthcareService' | 'Endpoint'>): this {
    return this.addToArray('informationProvider', informationProvider);
  }
