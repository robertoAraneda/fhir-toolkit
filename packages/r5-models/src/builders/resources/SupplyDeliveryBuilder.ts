...
export class SupplyDeliveryBuilder extends DomainResourceBuilder<SupplyDelivery, ISupplyDelivery> {
   ...
   */
  setType(type: ICodeableConcept<SupplyDeliverySupplyItemTypeType>): this {
    this.data.type = type;
    return this;
  }
   ...
   */
  addSuppliedItem(suppliedItem: ISupplyDeliverySuppliedItem): this {
    return this.addToArray('suppliedItem', suppliedItem);
  }
   ...
   */
  addReceiver(receiver: IReference<'Practitioner' | 'PractitionerRole' | 'Organization'>): this {
