...
export type ChoiceTypeValue<T extends string> =
  ...
  T extends 'RatioRange' ? IRatioRange :
  T extends 'Reference' ? IReference :
  T extends 'CodeableConcept' ? ICodeableConcept :
  T extends 'CodeableReference' ? ICodeableReference :
  ...
  // R5 new types
  T extends 'Availability' ? IAvailability :
  T extends 'ExtendedContactDetail' ? IExtendedContactDetail :
  T extends 'VirtualServiceDetail' ? IVirtualServiceDetail :
  T extends 'MonetaryComponent' ? IMonetaryComponent :
