...
export class TestScriptSetupActionAssertBuilder extends BackboneElementBuilder<TestScriptSetupActionAssert, ITestScriptSetupActionAssert> {
  ...
  /**
   * Set defaultManualCompletion
   * fail | pass | skip | stop
   */
  setDefaultManualCompletion(defaultManualCompletion: AssertionManualCompletionTypeType): this {
    this.data.defaultManualCompletion = defaultManualCompletion;
    return this;
  }
   ...
   */
  setStopTestOnFail(stopTestOnFail: boolean): this {
    this.data.stopTestOnFail = stopTestOnFail;
    return this;
  }
   ...
   */
  addRequirement(requirement: ITestScriptSetupActionAssertRequirement): this {
    return this.addToArray('requirement', requirement);
  }
