...
export class IngredientSubstanceStrengthReferenceStrengthBuilder extends BackboneElementBuilder<IngredientSubstanceStrengthReferenceStrength, IIngredientSubstanceStrengthReferenceStrength> {
  ...
  /**
   * Set strength choice type (strengthRatio, strengthRatioRange, strengthQuantity)
   * @param type - 'Ratio' | 'RatioRange' | 'Quantity'
   * @param value - The value for the chosen type
   *
   * @example
   * builder.setStrength('Ratio', value)
   */
  setStrength<T extends 'Ratio' | 'RatioRange' | 'Quantity'>(
    type: T,
    ...
    if (type !== 'Quantity') {
      otherKeys.push('strengthQuantity' as keyof IIngredientSubstanceStrengthReferenceStrength);
      otherKeys.push('_strengthQuantity' as keyof IIngredientSubstanceStrengthReferenceStrength);
    }
