...
export class ManufacturedItemDefinitionPropertyBuilder extends BackboneElementBuilder<ManufacturedItemDefinitionProperty, IManufacturedItemDefinitionProperty> {
  ...
  setValue<T extends 'CodeableConcept' | 'Quantity' | 'Date' | 'Boolean' | 'Markdown' | 'Attachment' | 'Reference'>(
    ...
    if (type !== 'Markdown') {
      otherKeys.push('valueMarkdown' as keyof IManufacturedItemDefinitionProperty);
      otherKeys.push('_valueMarkdown' as keyof IManufacturedItemDefinitionProperty);
    }
    if (type !== 'Attachment') {
    ...
    if (type !== 'Reference') {
      otherKeys.push('valueReference' as keyof IManufacturedItemDefinitionProperty);
      otherKeys.push('_valueReference' as keyof IManufacturedItemDefinitionProperty);
    }
