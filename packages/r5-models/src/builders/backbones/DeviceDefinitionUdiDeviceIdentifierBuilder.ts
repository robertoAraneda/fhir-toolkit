...
export class DeviceDefinitionUdiDeviceIdentifierBuilder extends BackboneElementBuilder<DeviceDefinitionUdiDeviceIdentifier, IDeviceDefinitionUdiDeviceIdentifier> {
  ...
  /**
   * Add marketDistribution
   * Indicates whether and when the device is available on the market
   */
  addMarketDistribution(marketDistribution: IDeviceDefinitionUdiDeviceIdentifierMarketDistribution): this {
    return this.addToArray('marketDistribution', marketDistribution);
  }
