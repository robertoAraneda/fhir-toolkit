...
import type {
  ...
  QuestionnaireAnswerConstraintType,
  QuestionnaireItemDisabledDisplayType,
...
export class QuestionnaireItemBuilder extends BackboneElementBuilder<QuestionnaireItem, IQuestionnaireItem> {
   ...
   * hidden | protected
   */
  setDisabledDisplay(disabledDisplay: QuestionnaireItemDisabledDisplayType): this {
    this.data.disabledDisplay = disabledDisplay;
    return this;
  }
  ...
  /**
   * Set answerConstraint
   * optionsOnly | optionsOrType | optionsOrString
   */
  setAnswerConstraint(answerConstraint: QuestionnaireAnswerConstraintType): this {
    this.data.answerConstraint = answerConstraint;
    return this;
  }
