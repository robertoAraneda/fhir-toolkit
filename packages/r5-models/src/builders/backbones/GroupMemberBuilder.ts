...
export class GroupMemberBuilder extends BackboneElementBuilder<GroupMember, IGroupMember> {
   ...
   */
  setEntity(entity: IReference<'CareTeam' | 'Device' | 'Group' | 'HealthcareService' | 'Location' | 'Organization' | 'Patient' | 'Practitioner' | 'PractitionerRole' | 'RelatedPerson' | 'Specimen'>): this {
