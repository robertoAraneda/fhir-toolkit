...
export class ExtensionBuilder extends ElementBuilder<Extension, IExtension> {
  ...
  setValue<T extends 'Base64Binary' | 'Boolean' | 'Canonical' | 'Code' | 'Date' | 'DateTime' | 'Decimal' | 'Id' | 'Instant' | 'Integer' | 'Integer64' | 'Markdown' | 'Oid' | 'PositiveInt' | 'String' | 'Time' | 'UnsignedInt' | 'Uri' | 'Url' | 'Uuid' | 'Address' | 'Age' | 'Annotation' | 'Attachment' | 'CodeableConcept' | 'CodeableReference' | 'Coding' | 'ContactPoint' | 'Count' | 'Distance' | 'Duration' | 'HumanName' | 'Identifier' | 'Money' | 'Period' | 'Quantity' | 'Range' | 'Ratio' | 'RatioRange' | 'Reference' | 'SampledData' | 'Signature' | 'Timing' | 'ContactDetail' | 'DataRequirement' | 'Expression' | 'ParameterDefinition' | 'RelatedArtifact' | 'TriggerDefinition' | 'UsageContext' | 'Availability' | 'ExtendedContactDetail' | 'Dosage' | 'Meta'>(
    ...
    if (type !== 'Integer64') {
      otherKeys.push('valueInteger64' as keyof IExtension);
      otherKeys.push('_valueInteger64' as keyof IExtension);
    }
    if (type !== 'Markdown') {
    ...
    if (type !== 'PositiveInt') {
      otherKeys.push('valuePositiveInt' as keyof IExtension);
      otherKeys.push('_valuePositiveInt' as keyof IExtension);
    }
    if (type !== 'String') {
    ...
    if (type !== 'UnsignedInt') {
      otherKeys.push('valueUnsignedInt' as keyof IExtension);
      otherKeys.push('_valueUnsignedInt' as keyof IExtension);
    }
    if (type !== 'Uri') {
    ...
    if (type !== 'Uuid') {
      otherKeys.push('valueUuid' as keyof IExtension);
      otherKeys.push('_valueUuid' as keyof IExtension);
    }
    if (type !== 'Address') {
    ...
    if (type !== 'CodeableReference') {
      otherKeys.push('valueCodeableReference' as keyof IExtension);
      otherKeys.push('_valueCodeableReference' as keyof IExtension);
    }
    if (type !== 'Coding') {
    ...
    if (type !== 'RatioRange') {
      otherKeys.push('valueRatioRange' as keyof IExtension);
      otherKeys.push('_valueRatioRange' as keyof IExtension);
    }
    if (type !== 'Reference') {
    ...
    if (type !== 'Availability') {
      otherKeys.push('valueAvailability' as keyof IExtension);
      otherKeys.push('_valueAvailability' as keyof IExtension);
    }
    if (type !== 'ExtendedContactDetail') {
      otherKeys.push('valueExtendedContactDetail' as keyof IExtension);
      otherKeys.push('_valueExtendedContactDetail' as keyof IExtension);
    }
    if (type !== 'Dosage') {
    ...
    if (type !== 'Meta') {
      otherKeys.push('valueMeta' as keyof IExtension);
      otherKeys.push('_valueMeta' as keyof IExtension);
    }
