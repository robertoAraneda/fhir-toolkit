 ...
 * @example
 * ```typescript
 * import { isPatient, isObservation } from '@fhir-toolkit/r5-types-models';
 *
...
/**
 * Check if a resource is a ActorDefinition
 * @param resource - The resource to check
 * @returns True if the resource is a ActorDefinition
 */
export function isActorDefinition(resource: any): resource is IActorDefinition {
  return resource?.resourceType === 'ActorDefinition';
}
...
/**
 * Check if a resource is a ArtifactAssessment
 * @param resource - The resource to check
 * @returns True if the resource is a ArtifactAssessment
 */
export function isArtifactAssessment(resource: any): resource is IArtifactAssessment {
  return resource?.resourceType === 'ArtifactAssessment';
}
...
/**
 * Check if a resource is a BiologicallyDerivedProductDispense
 * @param resource - The resource to check
 * @returns True if the resource is a BiologicallyDerivedProductDispense
 */
export function isBiologicallyDerivedProductDispense(resource: any): resource is IBiologicallyDerivedProductDispense {
  return resource?.resourceType === 'BiologicallyDerivedProductDispense';
}
...
/**
 * Check if a resource is a ConditionDefinition
 * @param resource - The resource to check
 * @returns True if the resource is a ConditionDefinition
 */
export function isConditionDefinition(resource: any): resource is IConditionDefinition {
  return resource?.resourceType === 'ConditionDefinition';
}
...
/**
 * Check if a resource is a DeviceAssociation
 * @param resource - The resource to check
 * @returns True if the resource is a DeviceAssociation
 */
export function isDeviceAssociation(resource: any): resource is IDeviceAssociation {
...
/**
 * Check if a resource is a DeviceDispense
 * @param resource - The resource to check
 * @returns True if the resource is a DeviceDispense
 */
export function isDeviceDispense(resource: any): resource is IDeviceDispense {
  return resource?.resourceType === 'DeviceDispense';
}
...
/**
 * Check if a resource is a DeviceUsage
 * @param resource - The resource to check
 * @returns True if the resource is a DeviceUsage
 */
export function isDeviceUsage(resource: any): resource is IDeviceUsage {
  return resource?.resourceType === 'DeviceUsage';
}
...
/**
 * Check if a resource is a EncounterHistory
 * @param resource - The resource to check
 * @returns True if the resource is a EncounterHistory
 */
export function isEncounterHistory(resource: any): resource is IEncounterHistory {
  return resource?.resourceType === 'EncounterHistory';
}
...
/**
 * Check if a resource is a FormularyItem
 * @param resource - The resource to check
 * @returns True if the resource is a FormularyItem
 */
export function isFormularyItem(resource: any): resource is IFormularyItem {
  return resource?.resourceType === 'FormularyItem';
}

/**
 * Check if a resource is a GenomicStudy
 * @param resource - The resource to check
 * @returns True if the resource is a GenomicStudy
 */
export function isGenomicStudy(resource: any): resource is IGenomicStudy {
  return resource?.resourceType === 'GenomicStudy';
}
...
/**
 * Check if a resource is a ImagingSelection
 * @param resource - The resource to check
 * @returns True if the resource is a ImagingSelection
 */
export function isImagingSelection(resource: any): resource is IImagingSelection {
  return resource?.resourceType === 'ImagingSelection';
}
...
/**
 * Check if a resource is a InventoryItem
 * @param resource - The resource to check
 * @returns True if the resource is a InventoryItem
 */
export function isInventoryItem(resource: any): resource is IInventoryItem {
  return resource?.resourceType === 'InventoryItem';
}

/**
 * Check if a resource is a InventoryReport
 * @param resource - The resource to check
 * @returns True if the resource is a InventoryReport
 */
export function isInventoryReport(resource: any): resource is IInventoryReport {
  return resource?.resourceType === 'InventoryReport';
}
...
/**
 * Check if a resource is a NutritionIntake
 * @param resource - The resource to check
 * @returns True if the resource is a NutritionIntake
 */
export function isNutritionIntake(resource: any): resource is INutritionIntake {
  return resource?.resourceType === 'NutritionIntake';
}
...
/**
 * Check if a resource is a Permission
 * @param resource - The resource to check
 * @returns True if the resource is a Permission
 */
export function isPermission(resource: any): resource is IPermission {
  return resource?.resourceType === 'Permission';
}
...
/**
 * Check if a resource is a RequestOrchestration
 * @param resource - The resource to check
 * @returns True if the resource is a RequestOrchestration
 */
export function isRequestOrchestration(resource: any): resource is IRequestOrchestration {
  return resource?.resourceType === 'RequestOrchestration';
}

/**
 * Check if a resource is a Requirements
 * @param resource - The resource to check
 * @returns True if the resource is a Requirements
 */
export function isRequirements(resource: any): resource is IRequirements {
  return resource?.resourceType === 'Requirements';
}
...
/**
 * Check if a resource is a SubstanceNucleicAcid
 * @param resource - The resource to check
 * @returns True if the resource is a SubstanceNucleicAcid
 */
export function isSubstanceNucleicAcid(resource: any): resource is ISubstanceNucleicAcid {
  return resource?.resourceType === 'SubstanceNucleicAcid';
}

/**
 * Check if a resource is a SubstancePolymer
 * @param resource - The resource to check
 * @returns True if the resource is a SubstancePolymer
 */
export function isSubstancePolymer(resource: any): resource is ISubstancePolymer {
  return resource?.resourceType === 'SubstancePolymer';
}

/**
 * Check if a resource is a SubstanceProtein
 * @param resource - The resource to check
 * @returns True if the resource is a SubstanceProtein
 */
export function isSubstanceProtein(resource: any): resource is ISubstanceProtein {
  return resource?.resourceType === 'SubstanceProtein';
}

/**
 * Check if a resource is a SubstanceReferenceInformation
 * @param resource - The resource to check
 * @returns True if the resource is a SubstanceReferenceInformation
 */
export function isSubstanceReferenceInformation(resource: any): resource is ISubstanceReferenceInformation {
  return resource?.resourceType === 'SubstanceReferenceInformation';
}

/**
 * Check if a resource is a SubstanceSourceMaterial
 * @param resource - The resource to check
 * @returns True if the resource is a SubstanceSourceMaterial
 */
export function isSubstanceSourceMaterial(resource: any): resource is ISubstanceSourceMaterial {
  return resource?.resourceType === 'SubstanceSourceMaterial';
}
...
/**
 * Check if a resource is a TestPlan
 * @param resource - The resource to check
 * @returns True if the resource is a TestPlan
 */
export function isTestPlan(resource: any): resource is ITestPlan {
  return resource?.resourceType === 'TestPlan';
}
...
/**
 * Check if a resource is a Transport
 * @param resource - The resource to check
 * @returns True if the resource is a Transport
 */
export function isTransport(resource: any): resource is ITransport {
  return resource?.resourceType === 'Transport';
}
