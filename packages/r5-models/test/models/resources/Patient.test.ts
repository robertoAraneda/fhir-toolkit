/**
 * Patient Resource Model and Builder Tests for FHIR R5
 *
...
import type { IPatient } from '@fhir-toolkit/r5-types';
import {
  ...
  describe('Builder', () => {
    describe('Basic Building', () => {
      ...
      it('should build with id', () => {
        const patient = new PatientBuilder().setId('123').build();

        expect(patient.id).toBe('123');
      });

      it('should build with active status', () => {
        const patient = new PatientBuilder().setActive(true).build();

        expect(patient.active).toBe(true);
      });

      it('should build with gender', () => {
        const patient = new PatientBuilder().setGender('female').build();

        expect(patient.gender).toBe('female');
      });

      it('should build with birthDate', () => {
        const patient = new PatientBuilder().setBirthDate('1990-05-20').build();
    ...
    describe('Choice Types', () => {
      it('should set deceasedBoolean', () => {
        const patient = new PatientBuilder().setDeceased('Boolean', true).build();
      ...
      it('should set deceasedDateTime', () => {
        const patient = new PatientBuilder().setDeceased('DateTime', '2023-01-01').build();
      ...
      it('should set multipleBirthBoolean', () => {
        const patient = new PatientBuilder().setMultipleBirth('Boolean', true).build();
      ...
      it('should set multipleBirthInteger', () => {
        const patient = new PatientBuilder().setMultipleBirth('Integer', 3).build();
    ...
    describe('Array Properties', () => {
      ...
      it('should add addresses', () => {
        const patient = new PatientBuilder().addAddress({ city: 'Springfield' }).build();

        expect(patient.address).toHaveLength(1);
      });

      it('should add contacts', () => {
        const patient = new PatientBuilder().addContact({ name: { family: 'Smith' } }).build();
    ...
    describe('Fluent API', () => {
      ...
      it('should allow overwriting properties', () => {
        const patient = new PatientBuilder().setGender('male').setGender('female').build();
    ...
    describe('Build Result', () => {
      ...
      it('should produce clonable result', () => {
        const original = new PatientBuilder().setId('123').addName({ family: 'Doe' }).build();
