...
export type TherapyRelationshipTypeType = 'contraindicated-only-with' | 'contraindicated-except-with' | 'indicated-only-with' | 'indicated-except-with' | 'indicated-only-before' | 'replace-other-therapy' | 'replace-other-therapy-contraindicated' | 'replace-other-therapy-not-tolerated' | 'replace-other-therapy-not-effective';
...
export const TherapyRelationshipTypeValues = ['contraindicated-only-with', 'contraindicated-except-with', 'indicated-only-with', 'indicated-except-with', 'indicated-only-before', 'replace-other-therapy', 'replace-other-therapy-contraindicated', 'replace-other-therapy-not-tolerated', 'replace-other-therapy-not-effective'] as const;
