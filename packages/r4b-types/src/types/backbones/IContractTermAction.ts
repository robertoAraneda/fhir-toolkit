 ...
 * 
 *
 * @see https://hl7.org/fhir/R4B/contracttermaction.html
 */
export interface IContractTermAction extends IBackboneElement {
   ...
   * Why is action (not) needed?
   */
  reasonReference?: IReference<'Condition' | 'Observation' | 'DiagnosticReport' | 'DocumentReference' | 'Questionnaire' | 'QuestionnaireResponse'>[];
