...
import type { IMedicationKnowledgeRegulatorySchedule } from './IMedicationKnowledgeRegulatorySchedule.js';
 ...
 * 
 *
 * @see https://hl7.org/fhir/R4B/medicationknowledgeregulatory.html
 */
