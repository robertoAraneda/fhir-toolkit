 ...
 * 
 *
 * @see https://hl7.org/fhir/R4B/clinicalusedefinition.html
 */
export interface IClinicalUseDefinition extends IDomainResource {
   ...
   */
  subject?: IReference<'MedicinalProductDefinition' | 'Medication' | 'ActivityDefinition' | 'PlanDefinition' | 'Device' | 'DeviceDefinition' | 'Substance'>[];
