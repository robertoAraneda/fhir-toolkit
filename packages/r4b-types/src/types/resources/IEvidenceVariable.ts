...
import type { CharacteristicCombinationType, EvidenceVariableHandlingType, PublicationStatusType } from '../../valuesets/index.js';
...
export interface IEvidenceVariable extends IDomainResource {
   ...
   * intersection | union
   */
  characteristicCombination?: CharacteristicCombinationType;
  /**
   * Extension for characteristicCombination
   */
  _characteristicCombination?: IElement;
