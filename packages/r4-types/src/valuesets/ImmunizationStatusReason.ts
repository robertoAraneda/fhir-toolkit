...
export type ImmunizationStatusReasonType = 'IMMUNE' | 'MEDPREC' | 'OSTOCK' | 'PATOBJ';
...
export const ImmunizationStatusReasonValues = ['IMMUNE', 'MEDPREC', 'OSTOCK', 'PATOBJ'] as const;
