...
export type TaskCodeType = 'approve' | 'fulfill' | 'abort' | 'replace' | 'change' | 'suspend' | 'resume';
...
export const TaskCodeValues = ['approve', 'fulfill', 'abort', 'replace', 'change', 'suspend', 'resume'] as const;
