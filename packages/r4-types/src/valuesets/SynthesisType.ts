...
export type SynthesisTypeType = 'std-MA' | 'IPD-MA' | 'indirect-NMA' | 'combined-NMA' | 'range' | 'classification';
...
export const SynthesisTypeValues = ['std-MA', 'IPD-MA', 'indirect-NMA', 'combined-NMA', 'range', 'classification'] as const;
