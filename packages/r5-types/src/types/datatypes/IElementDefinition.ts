import type { IBackboneType, ICodeableConcept, ICoding, IElement, IReference } from '../../base/index.js';
...
import type { IElementDefinitionBase } from '../backbones/IElementDefinitionBase.js';
import type { IElementDefinitionBinding } from '../backbones/IElementDefinitionBinding.js';
import type { IElementDefinitionConstraint } from '../backbones/IElementDefinitionConstraint.js';
import type { IElementDefinitionExample } from '../backbones/IElementDefinitionExample.js';
import type { IElementDefinitionMapping } from '../backbones/IElementDefinitionMapping.js';
import type { IElementDefinitionSlicing } from '../backbones/IElementDefinitionSlicing.js';
import type { IElementDefinitionType } from '../backbones/IElementDefinitionType.js';
import type { PropertyRepresentationType } from '../../valuesets/index.js';
 ...
 * 
 *
 * @see https://hl7.org/fhir/R5/elementdefinition.html
 */
export interface IElementDefinition extends IBackboneType {
  /**
   ...
   */
  _defaultValueInteger64?: IElement;
   ...
   * Specified value if missing from instance
   */
  defaultValueAvailability?: IAvailability;

  /**
   * Specified value if missing from instance
   */
  defaultValueExtendedContactDetail?: IExtendedContactDetail;
   ...
   * Value must be exactly this
   */
  fixedAvailability?: IAvailability;

  /**
   * Value must be exactly this
   */
  fixedExtendedContactDetail?: IExtendedContactDetail;
   ...
   * Value must have at least these property values
   */
  patternAvailability?: IAvailability;

  /**
   * Value must have at least these property values
   */
  patternExtendedContactDetail?: IExtendedContactDetail;
