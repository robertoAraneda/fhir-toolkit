...
import type { IPlanDefinitionActionInput } from './IPlanDefinitionActionInput.js';
import type { IPlanDefinitionActionOutput } from './IPlanDefinitionActionOutput.js';
...
export interface IPlanDefinitionAction extends IBackboneElement {
   ...
   */
  input?: IPlanDefinitionActionInput[];

  /**
   * Output data definition
   */
  output?: IPlanDefinitionActionOutput[];
