...
import type { ICoverageEligibilityRequestEvent } from '../backbones/ICoverageEligibilityRequestEvent.js';
 ...
 * 
 *
 * @see https://hl7.org/fhir/R5/coverageeligibilityrequest.html
 */
export interface ICoverageEligibilityRequest extends IDomainResource {
   ...
   * Event information
   */
  event?: ICoverageEligibilityRequestEvent[];
