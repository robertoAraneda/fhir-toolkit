 ...
 *
 * @see http://hl7.org/fhir/ValueSet/transport-code
 */

export type TransportCodeType = 'approve' | 'fulfill' | 'instantiate' | 'abort' | 'replace' | 'change' | 'suspend' | 'resume';
...
export const TransportCodeValues = ['approve', 'fulfill', 'instantiate', 'abort', 'replace', 'change', 'suspend', 'resume'] as const;
