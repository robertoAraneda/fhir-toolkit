/**
 * Extract FHIR R5 specs from bundle files
 *
 * This script extracts individual StructureDefinition, ValueSet, and CodeSystem
 * resources from the FHIR R5 specification bundles.
 */
...
const CODEGEN_SPECS = join(__dirname, '../../codegen/specs/r5');
...
async function main(): Promise<void> {
  console.log('🔧 Extracting FHIR R5 Specifications\n');
